...
public class 예외처리_5 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b3) {
			...
			if(s==3) {
				int a=JOptionPane.showConfirmDialog(this, "게임 종료", "종료할까요?", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
				if(a==JOptionPane.YES_OPTION) {
					...
					tf.setText("");
					getRand();
					JOptionPane.showConfirmDialog(this, "새게임을 시작합니다");
				}
			}
		}
	}
