 ...
 * 				class ManiClass => mainClass.java
 * 					  ---------    ---------
 * 						  |            |
 * 						  -------------- 일치
 * 			=> EditPlus / 울투라Edit
 ...
 * 				=> 기본
 * 			문자
 * 				문자 한 개만 저장 => 0~65535 (각국의 언어사용이 가능)
 * 				char => 표현식 ''
 * 			논리
