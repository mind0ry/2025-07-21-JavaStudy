 ...
 * 			인스턴스 변수 : 선택 , 선언시 대입 , 생성자에서 대입 , 기본값이 있다
 * 			정적변수 : 선택 , 선언시 대입 , 초기화 블록 , 기본값이 있다 
 * 
 * 		*** 초기화 방법
 * 			1) 선언과 동시에 초기화 : 명시적 초기화	
...
public class 객체지향용어_1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("s.hakbun="+s.hakbun);
		System.out.println("s.name="+s.name);
		
		Student s2=new Student(5);
		System.out.println("s2.hakbun="+s2.hakbun);
		System.out.println("s2.name="+s2.name);
		
		Student s3=new Student("심청이");
		System.out.println("s3.hakbun="+s3.hakbun);
		System.out.println("s3.name="+s3.name);
		
		Student s4=new Student(7,"이순신");
		System.out.println("s4.hakbun="+s4.hakbun);
